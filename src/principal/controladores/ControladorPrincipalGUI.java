...
public class ControladorPrincipalGUI {
    ...
    */
        ...
        VentanaAMCliente cliente = new VentanaAMCliente(null);
        ventana.setLocationRelativeTo(null);
       ...
       //EMPLEADO 
        ...
        VentanaAMEmpleado empleado = new VentanaAMEmpleado(null);
        ventana.setLocationRelativeTo(null);
       ...
       //ENCARGADO
        ...
        VentanaAMEncargado encargado = new VentanaAMEncargado(null);
        ventana.setLocationRelativeTo(null);
